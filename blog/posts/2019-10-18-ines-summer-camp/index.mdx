...
For now, we can't disclose much about the idea itself, so this blog post is going to be about the path and the processes we choose to bring it into life. In the next few months we hope to have news, so stay tuned for more.
...
![Design Sprint room on converge day](photo1.jpg)

Design Sprint room on converge day
...
![The end of Summer Camp](photo3.jpg)
